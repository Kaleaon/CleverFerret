...
class FanfictionMetadataService @Inject constructor(
    ...
    private fun mergeMetadata(
        ...
        return FanfictionMetadata(
            ...
            warnings = (online?.warnings ?: embedded?.warnings).ifEmpty { emptyList() },
            categories = (online?.categories ?: embedded?.categories).ifEmpty { emptyList() },
            relationships = (online?.relationships ?: embedded?.relationships).ifEmpty { emptyList() },
            characters = (online?.characters ?: embedded?.characters).ifEmpty { emptyList() },
            ...
            collections = (online?.collections ?: embedded?.collections).ifEmpty { emptyList() },
