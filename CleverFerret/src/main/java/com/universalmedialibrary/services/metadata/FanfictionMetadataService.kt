...
class FanfictionMetadataService @Inject constructor(
    ...
    private fun mergeMetadata(
        ...
        return FanfictionMetadata(
            ...
            warnings = online?.warnings ?: embedded?.warnings ?: emptyList(),
            categories = online?.categories ?: embedded?.categories ?: emptyList(),
            relationships = online?.relationships ?: embedded?.relationships ?: emptyList(),
            characters = online?.characters ?: embedded?.characters ?: emptyList(),
            ...
            collections = online?.collections ?: embedded?.collections ?: emptyList(),
