...
class FanfictionMetadataService @Inject constructor(
    ...
    private fun mergeMetadata(
        ...
        return FanfictionMetadata(
            ...
            warnings = (online?.warnings ?: embedded?.warnings ?: emptyList()).ifEmpty { emptyList() },
            categories = (online?.categories ?: embedded?.categories ?: emptyList()).ifEmpty { emptyList() },
            relationships = (online?.relationships ?: embedded?.relationships ?: emptyList()).ifEmpty { emptyList() },
            characters = (online?.characters ?: embedded?.characters ?: emptyList()).ifEmpty { emptyList() },
