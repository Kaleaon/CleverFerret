...
enum class PlexThemePreset(
    val displayName: String,
    val description: String,
    val isDark: Boolean
) {
    // Dark themes
    PLEX_DARK("Plex Dark", "Classic Plex dark theme with orange accent", true),
    ...
    // Light themes
    PLEX_LIGHT("Plex Light", "Light theme with orange accent", false),
...
fun getThemeColors(preset: PlexThemePreset): PlexThemeColors {
    return when (preset) {
        // ===================== DARK THEMES =====================
        PlexThemePreset.PLEX_DARK -> PlexThemeColors(
        ...
        PlexThemePreset.MIDNIGHT -> PlexThemeColors(
        ...
        PlexThemePreset.AMOLED -> PlexThemeColors(
        ...
        PlexThemePreset.DRACULA -> PlexThemeColors(
        ...
        PlexThemePreset.NORD -> PlexThemeColors(
        ...
        PlexThemePreset.MONOKAI -> PlexThemeColors(
        ...
        PlexThemePreset.OCEAN -> PlexThemeColors(
        ...
        PlexThemePreset.FOREST -> PlexThemeColors(
        ...
        // ===================== LIGHT THEMES =====================
        PlexThemePreset.PLEX_LIGHT -> PlexThemeColors(
        ...
        PlexThemePreset.PAPER -> PlexThemeColors(
        ...
        PlexThemePreset.CREAM -> PlexThemeColors(
        ...
        // ===================== READING THEMES =====================
        PlexThemePreset.SEPIA -> PlexThemeColors(
        ...
        PlexThemePreset.NIGHT_RED -> PlexThemeColors(
        ...
        // ===================== E-INK THEMES =====================
        PlexThemePreset.EINK -> PlexThemeColors(
        ...
        PlexThemePreset.EINK_DARK -> PlexThemeColors(
            background = Color(0xFF000000),
        ...
        // ===================== ACCENT COLOR THEMES =====================
        PlexThemePreset.NETFLIX -> PlexThemeColors(
        ...
        PlexThemePreset.SPOTIFY -> PlexThemeColors(
        ...
        PlexThemePreset.PURPLE_HAZE -> PlexThemeColors(
        ...
        PlexThemePreset.TEAL -> PlexThemeColors(
        ...
        PlexThemePreset.PINK -> PlexThemeColors(
        ...
        PlexThemePreset.GOLD -> PlexThemeColors(
 ...
 */
val LocalPlexTheme = compositionLocalOf { getThemeColors(PlexThemePreset.PLEX_DARK) }
...
@Composable
fun PlexTheme(
    preset: PlexThemePreset = PlexThemePreset.PLEX_DARK,
    customColors: PlexThemeColors? = null,
    content: @Composable () -> Unit
) {
    val colors = customColors ?: getThemeColors(preset)
    
    CompositionLocalProvider(LocalPlexTheme provides colors) {
        MaterialTheme(
