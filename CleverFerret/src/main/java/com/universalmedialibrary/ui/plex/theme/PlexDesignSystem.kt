package com.universalmedialibrary.ui.plex.theme
...
/**
 * CleverFerret Plex-Inspired Design System
 * 
 * A sophisticated, media-centric design system inspired by Plex's dark,
...
/**
 * Core Plex-inspired color palette
 ...
 */
val PlexDarkColorScheme = darkColorScheme(
    primary = PlexColors.AccentPrimary,
    onPrimary = PlexColors.TextOnAccent,
    primaryContainer = PlexColors.AccentTertiary,
    onPrimaryContainer = PlexColors.TextPrimary,
    
    secondary = PlexColors.AccentSecondary,
    onSecondary = PlexColors.TextOnAccent,
    secondaryContainer = PlexColors.BackgroundSurface,
    onSecondaryContainer = PlexColors.TextPrimary,
    
    tertiary = PlexColors.MediaTypes.Book,
    onTertiary = PlexColors.TextOnAccent,
    tertiaryContainer = PlexColors.BackgroundSurface,
    onTertiaryContainer = PlexColors.TextPrimary,
    
    background = PlexColors.Background,
    onBackground = PlexColors.TextPrimary,
    
    surface = PlexColors.BackgroundElevated,
    onSurface = PlexColors.TextPrimary,
    surfaceVariant = PlexColors.BackgroundSurface,
    onSurfaceVariant = PlexColors.TextSecondary,
    
    surfaceTint = PlexColors.AccentPrimary,
    inverseSurface = PlexColors.TextPrimary,
    inverseOnSurface = PlexColors.Background,
    inversePrimary = PlexColors.AccentTertiary,
    
    error = PlexColors.Error,
    onError = PlexColors.TextPrimary,
    errorContainer = PlexColors.Error.copy(alpha = 0.2f),
    onErrorContainer = PlexColors.Error,
    
    outline = PlexColors.Border,
    outlineVariant = PlexColors.Divider,
 ...
 * Plex-themed shapes
 */
val PlexShapes = Shapes(
    extraSmall = androidx.compose.foundation.shape.RoundedCornerShape(PlexCorners.XS),
    small = androidx.compose.foundation.shape.RoundedCornerShape(PlexCorners.SM),
    medium = androidx.compose.foundation.shape.RoundedCornerShape(PlexCorners.MD),
    large = androidx.compose.foundation.shape.RoundedCornerShape(PlexCorners.LG),
    extraLarge = androidx.compose.foundation.shape.RoundedCornerShape(PlexCorners.XL)
)
 ...
 */
val LocalPlexColors = staticCompositionLocalOf { PlexColors }

/**
 * Accent theme configuration
 */
enum class PlexAccentTheme {
    PLEX_GOLD,
    FERRET_ORANGE,
    NETFLIX_RED,
    SPOTIFY_GREEN,
...
val LocalPlexAccent = staticCompositionLocalOf {
    PlexAccentColors(
        primary = PlexColors.AccentPrimary,
        secondary = PlexColors.AccentSecondary,
        tertiary = PlexColors.AccentTertiary,
        glow = PlexColors.AccentGlow
    )
}
 ...
 */
fun getAccentColors(theme: PlexAccentTheme, customColor: Color? = null): PlexAccentColors {
    return when (theme) {
        PlexAccentTheme.PLEX_GOLD -> PlexAccentColors(
            primary = PlexColors.Themes.PlexGold,
            secondary = Color(0xFFF5B82E),
            tertiary = Color(0xFFCC8A00),
            glow = Color(0xFFFFD54F)
        )
        PlexAccentTheme.FERRET_ORANGE -> PlexAccentColors(
            primary = PlexColors.Themes.FerretOrange,
            secondary = Color(0xFFFF8A50),
            tertiary = Color(0xFFE65100),
            glow = Color(0xFFFFAB40)
        )
        PlexAccentTheme.NETFLIX_RED -> PlexAccentColors(
            primary = PlexColors.Themes.NetflixRed,
            secondary = Color(0xFFFF4444),
            tertiary = Color(0xFFB20000),
            glow = Color(0xFFFF6666)
        )
        PlexAccentTheme.SPOTIFY_GREEN -> PlexAccentColors(
            primary = PlexColors.Themes.SpotifyGreen,
            secondary = Color(0xFF1ED760),
            tertiary = Color(0xFF0D9E40),
            glow = Color(0xFF4AE17D)
        )
        PlexAccentTheme.PRIME_BLUE -> PlexAccentColors(
            primary = PlexColors.Themes.PrimeBlue,
            secondary = Color(0xFF33B5E5),
            tertiary = Color(0xFF007BB8),
            glow = Color(0xFF66D9FF)
        )
        PlexAccentTheme.DISNEY_BLUE -> PlexAccentColors(
            primary = PlexColors.Themes.DisneyBlue,
            secondary = Color(0xFF2255FF),
            tertiary = Color(0xFF0A2A99),
            glow = Color(0xFF5577FF)
        )
        PlexAccentTheme.HBO_PURPLE -> PlexAccentColors(
            primary = PlexColors.Themes.HBOPurple,
            secondary = Color(0xFFAA33FF),
            tertiary = Color(0xFF6600AA),
            glow = Color(0xFFCC66FF)
        )
        PlexAccentTheme.CUSTOM -> PlexAccentColors(
            primary = customColor ?: PlexColors.AccentPrimary,
            secondary = (customColor ?: PlexColors.AccentPrimary).copy(alpha = 0.8f),
            tertiary = (customColor ?: PlexColors.AccentPrimary).copy(alpha = 0.6f),
            glow = (customColor ?: PlexColors.AccentPrimary).copy(alpha = 0.4f)
        )
    }
}
...
fun PlexAccentTheme(
    ...
    CompositionLocalProvider(
        LocalPlexColors provides PlexColors,
        LocalPlexAccent provides accentColors
    ) {
        MaterialTheme(
