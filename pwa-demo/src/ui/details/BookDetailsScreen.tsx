...
import { ArrowBack, PlayArrow, Edit, Share, Favorite, Star } from '@mui/icons-material';
        ...
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={3}>
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Typography variant="body1" paragraph>
              Book description will appear here. This includes summary, plot, and other details
              about the book.
            </Typography>
