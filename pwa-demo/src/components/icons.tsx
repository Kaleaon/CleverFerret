...
export const MovieIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg {...iconProps} className={className || iconProps.className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3.75v3.75m3.75-3.75v3.75m-7.5-12.75h12v11.25a2.25 2.25 0 01-2.25 2.25H8.25a2.25 2.25 0 01-2.25-2.25V6.75z" />
  </svg>
);

export const MusicIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg {...iconProps} className={className || iconProps.className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.07 1.918l-4.5 2.25a2.25 2.25 0 01-2.36 0l-4.5-2.25A2.25 2.25 0 013 16.553V12.8a2.25 2.25 0 011.07-1.918l4.5-2.25a2.25 2.25 0 012.36 0L19.5 9z" />
  </svg>
);

export const ComicIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg {...iconProps} className={className || iconProps.className}>
     <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1.5-1.5m1.5 1.5l1.5-1.5m0 0l-1.5 1.5m-7.5-9l-1.5-1.5M9 7.5l1.5-1.5M9 7.5l-1.5 1.5m1.5-1.5l1.5 1.5M15 7.5l-1.5-1.5m1.5 1.5l1.5-1.5m-7.5 4.5l-1.5-1.5m1.5 1.5l1.5-1.5" />
  </svg>
);

export const PodcastIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg {...iconProps} className={className || iconProps.className}>
     <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5a6 6 0 00-6-6h-1.5a6 6 0 00-6 6v1.5a6 6 0 006 6h1.5z" />
     <path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25a3 3 0 003-3v-1.5a3 3 0 00-3-3h-1.5a3 3 0 00-3 3v1.5a3 3 0 003 3h1.5z" />
  </svg>
);

export const RadioIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg {...iconProps} className={className || iconProps.className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.03 1.125 0 1.131.094 1.976 1.057 1.976 2.192V7.5m-9 3c0 4.5 3 8.25 7.5 8.25s7.5-3.75 7.5-8.25" />
  </svg>
);
